...
<?php
      ...
      $contentsql = "SELECT * FROM table_review WHERE user_id = '$sesuser' ORDER BY review_date DESC";
              ...
              <div class="panel-body">
                <table class="table table-striped table-hover">
                    ...
                    while ($contentdata = mysql_fetch_assoc($contentqry)) {
                     ?>
                    <tr>
                      <td><?php echo $contentdata['review_id']; ?></td>
                      <td><?php echo $contentdata['review_rating']; ?></td>
                      <td><?php echo $contentdata['review_comment']; ?></td>
                      <td><?php echo date ('d-M-Y', strtotime($contentdata['review_date'])); ?></td>
                    </tr>
                    <?php
                      }
                     ?>
