              ...
              <div class="panel-body">
                <table class="table table-striped table-hover">
                    ...
                    <tr>
                      ...
                      <td><a class="btn btn-default" href="editpost.php?post=<?php echo $contentdata['post_id'];?>">Edit</a> </td>
                      <td><a class="btn btn-danger" href="../php/post_delete.php?post=<?php echo $contentdata['post_id'];?>">Delete</a></td>
                    </tr>
                    <?php
                      }
                     ?>
